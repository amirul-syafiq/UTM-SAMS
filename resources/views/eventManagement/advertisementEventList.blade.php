        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if ($eventAdvertisements->isEmpty())
                <div class="text-center">
                    ...
                    <br>
                    <a href="{{ route('event-advertisement.createEventAdvertisementForm', $event_id) }}"
                    ...
                    @foreach ($eventAdvertisements as $eventAdvertisement)
                        <x-custom-event-card :event="$eventAdvertisement">
                            <div class="text-right p-3">
                                <a href="{{ route('event-advertisement.updateEventAdvertisementForm', ['clubEventId' => $event_id,'eventAdvertisementId'=>$eventAdvertisement->id]) }}"
