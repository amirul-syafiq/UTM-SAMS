...
@endif
    <x-custom-form title="Please fill in all the detail" button-text="Create Event" action="{{ route('event.createEvent') }}">
        <div>
            ...
            <x-input id="eventName" class="block mt-1 w-full" type="text" name="eventName" :value="old('name')" required autofocus autocomplete="Event Name" />
        </div>
        ...
        <div>
            ...
            <x-input id="eventVenue" class="block mt-1 w-full" type="text" name="eventVenue" :value="old('eventVenue')" required autofocus autocomplete="Event Venue" />
        </div>

        <div>
            <x-label for="eventStartDateTime" value="{{ __('Event Start Date and Time') }}" />
            <x-input id="eventStartDateTime" class="block mt-1 w-full" type="datetime-local" name="eventStartDateTime" :value="old('eventStartDateTime')" required autofocus autocomplete="Event Start Date and Time" />
        </div>

        <div>
            <x-label for="eventEndDateTime" value="{{ __('Event End Date and Time') }}" />
            <x-input id="eventEndDateTime" class="block mt-1 w-full" type="datetime-local" name="eventEndDateTime" :value="old('eventEndDateTime')" required autofocus autocomplete="Event End Date and Time" />
        </div>
        ...
        <div>
            ...
            <x-custom-dropdown name="eventStatus" :options="$eventStatusList" selected="old(eventStatusList)" label="Event Status" />
        </div>
    </x-custom-form>
